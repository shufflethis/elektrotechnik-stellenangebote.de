  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von elektrotechnik-stellenangebote.de. Mit jahrelanger Erfahrung im
      ...
      <div className="autorenbox-links">
        <a href="https://elektrotechnik-stellenangebote.de/autor/thomas-sander">Mehr ueber den Autor</a>
      </div>
    </div>
  );
};
